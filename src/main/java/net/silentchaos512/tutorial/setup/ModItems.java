...
import net.silentchaos512.tutorial.setup.items.*;
...
public class ModItems {
    ...
    /* teorite_sword */
        public static final RegistryObject<SwordItem> TEORITE_SWORD = Registration.ITEMS.register("teorite_sword", () ->
                new SwordItem(ItemTier.STONE, 3, -2.4f, (new Item.Properties().tab(TutorialMod.TAB_EQUIP_HABITAT))));
    /* teorite_pickaxe */
        public static final RegistryObject<PickaxeItem> TEORITE_PICKAXE = Registration.ITEMS.register("teorite_pickaxe", () ->
                new customPickaxe(ToolMaterialList.teorite_pickaxe, 0, 0f, (new Item.Properties().tab(TutorialMod.TAB_EQUIP_HABITAT))));
    /* teorite_pickaxe */
    public static final RegistryObject<AxeItem> TEORITE_AXE = Registration.ITEMS.register("teorite_axe", () ->
            new customAxe(ToolMaterialList.teorite_axe, 9, -3.1f, (new Item.Properties().tab(TutorialMod.TAB_EQUIP_HABITAT))));
    /* teorite_shovel */
    public static final RegistryObject<ShovelItem> TEORITE_SHOVEL = Registration.ITEMS.register("teorite_shovel", () ->
            new customShovel(ToolMaterialList.teorite_shovel, 0, -0.2f, (new Item.Properties().tab(TutorialMod.TAB_EQUIP_HABITAT))));
    /* teorite_hoe */
    public static final RegistryObject<HoeItem> TEORITE_HOE = Registration.ITEMS.register("teorite_hoe", () ->
            new customHoe(ToolMaterialList.teorite_hoe, 0, -0.2f, (new Item.Properties().tab(TutorialMod.TAB_EQUIP_HABITAT))));
